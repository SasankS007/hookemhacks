        ...
        <div className="flex flex-col rounded-[2.25rem] border-[6px] border-slate-900 bg-[#fde047] p-4 shadow-[14px_14px_0_#1e293b]">
          ...
          <div className="mb-3 flex items-center gap-3 px-1">
            ...
            <div>
              ...
              <p className="font-vt323 text-xl text-[#306230]">NEW PLAYER</p>
            </div>
          </div>
          ...
          <div className="rounded-[1.35rem] border-[5px] border-slate-900 bg-[#9bbc0f] p-4 shadow-[inset_0_0_24px_rgba(15,23,42,0.2)]">
            <form onSubmit={handleSignup} className="flex flex-col gap-3">
              <div className="flex flex-col gap-1">
                <label className="font-pixel text-[7px] text-[#306230]">USERNAME</label>
                <input
                  type="text"
                  required
                  value={username}
              ...
              <div className="flex flex-col gap-1">
                <label className="font-pixel text-[7px] text-[#306230]">CONFIRM</label>
                <input
                  type="password"
                  required
                  value={confirm}
          ...
          <div className="mt-3 flex items-center justify-between px-1">
            <p className="font-vt323 text-sm text-[#306230]">Have an account?</p>
            <Link
              href="/auth/login"
